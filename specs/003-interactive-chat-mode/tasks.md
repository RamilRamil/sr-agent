...
- [x] T028 Run `specs/003-interactive-chat-mode/quickstart.md` end-to-end against a real project + Ollama; fix any drift.
- [x] T029 Run the full suite `PYTHONPATH=. .venv/bin/python -m pytest tests/ -q` (excluding live-only integration), confirm green, mark T001–T029 done.
